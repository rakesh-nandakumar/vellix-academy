...
export const metadata = {
  ...
  description:
    "Browse enterprise IT courses at Vellix Academy. Foundation, Business IT, Software Development, and Cybersecurity programs.",
};
      ...
      <section className="py-20 sm:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <SectionHeading
            ...
            title="Courses Built for Industry Readiness"
            subtitle="Our programs are designed to bridge the gap between education and real-world industry requirements through practical learning, business scenarios, projects, and career-focused training."
          />
          <CourseExplorer />
        </div>
      </section>
      ...
      <section className="bg-gradient-to-br from-navy-950 via-navy-900 to-slate-900 py-16 sm:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <SectionHeading
            ...
            subtitle="We are continuously expanding our curriculum to meet industry demands. Stay tuned for these upcoming programs."
            dark
          />
